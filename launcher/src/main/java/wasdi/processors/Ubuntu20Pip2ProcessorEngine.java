...
public class Ubuntu20Pip2ProcessorEngine extends DockerBuildOnceEngine{
	/**
	 * Default constructor
	 */
	public Ubuntu20Pip2ProcessorEngine() {
		super();
		if (!m_sDockerTemplatePath.endsWith("/")) m_sDockerTemplatePath += "/";
		m_sDockerTemplatePath += ProcessorTypes.getTemplateFolder(ProcessorTypes.PYTHON_PIP_2_UBUNTU_20);
