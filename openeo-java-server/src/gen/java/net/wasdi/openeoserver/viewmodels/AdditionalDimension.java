 ...
 */
@JsonPropertyOrder({
  AdditionalDimension.JSON_PROPERTY_EXTENT,
  AdditionalDimension.JSON_PROPERTY_VALUES,
  AdditionalDimension.JSON_PROPERTY_STEP,
  AdditionalDimension.JSON_PROPERTY_UNIT,
  AdditionalDimension.JSON_PROPERTY_REFERENCE_SYSTEM
})
...
public class AdditionalDimension   {
  ...
  private List<CollectionDimensionValuesInner> values = null;
  ...
  public AdditionalDimension values(List<CollectionDimensionValuesInner> values) {
    this.values = values;
    return this;
  }

  public AdditionalDimension addValuesItem(CollectionDimensionValuesInner valuesItem) {
    if (this.values == null) {
  ...
  @Valid  @Size(min=1)
  public List<CollectionDimensionValuesInner> getValues() {
    return values;
  }

  public void setValues(List<CollectionDimensionValuesInner> values) {
    this.values = values;
  }
  ...
  @ApiModelProperty(value = "The unit of measurement for the data, preferably compliant to [UDUNITS-2](https://ncics.org/portfolio/other-resources/udunits2/) units (singular).")
   ...
   **/
  @JsonProperty(value = "reference_system")
