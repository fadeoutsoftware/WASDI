 ...
 */
@JsonPropertyOrder({
  BatchJobEstimate.JSON_PROPERTY_COSTS,
  BatchJobEstimate.JSON_PROPERTY_DURATION,
  BatchJobEstimate.JSON_PROPERTY_SIZE,
  BatchJobEstimate.JSON_PROPERTY_DOWNLOADS_INCLUDED,
  BatchJobEstimate.JSON_PROPERTY_EXPIRES
})
...
public class BatchJobEstimate   {
  ...
  public static final String JSON_PROPERTY_DOWNLOADS_INCLUDED = "downloads_included";
  @JsonProperty(JSON_PROPERTY_DOWNLOADS_INCLUDED)
   ...
   **/
  @JsonProperty(value = "downloads_included")
  ...
  public BatchJobEstimate expires(Date expires) {
    this.expires = expires;
    return this;
  }

  /**
   * Time until which the estimate is valid, formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.
   * @return expires
   **/
  @JsonProperty(value = "expires")
  @ApiModelProperty(example = "2020-11-01T00:00Z", value = "Time until which the estimate is valid, formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.")
