...
@JsonPropertyOrder({
  SpatialDimension.JSON_PROPERTY_AXIS,
  SpatialDimension.JSON_PROPERTY_EXTENT,
  SpatialDimension.JSON_PROPERTY_VALUES,
  SpatialDimension.JSON_PROPERTY_STEP,
  SpatialDimension.JSON_PROPERTY_REFERENCE_SYSTEM
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJerseyServerCodegen", date = "2023-03-29T12:14:04.450152500+02:00[Europe/Rome]")@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "axis", visible = true)
@JsonSubTypes({
  @JsonSubTypes.Type(value = DimensionSpatialHorizontal.class, name = "x"),
  @JsonSubTypes.Type(value = DimensionSpatialHorizontal.class, name = "y"),
  @JsonSubTypes.Type(value = DimensionSpatialVertical.class, name = "z"),
})
...
public class SpatialDimension   {
  ...
  private OneOfstringnumber referenceSystem;
