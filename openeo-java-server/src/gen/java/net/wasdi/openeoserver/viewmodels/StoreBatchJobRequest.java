 ...
 */
@JsonPropertyOrder({
  StoreBatchJobRequest.JSON_PROPERTY_TITLE,
  StoreBatchJobRequest.JSON_PROPERTY_DESCRIPTION,
  StoreBatchJobRequest.JSON_PROPERTY_PROCESS,
  StoreBatchJobRequest.JSON_PROPERTY_PLAN,
  StoreBatchJobRequest.JSON_PROPERTY_BUDGET
})
