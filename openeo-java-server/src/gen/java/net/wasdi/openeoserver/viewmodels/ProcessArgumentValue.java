...
@JsonPropertyOrder({
  ProcessArgumentValue.JSON_PROPERTY_FROM_PARAMETER,
  ProcessArgumentValue.JSON_PROPERTY_FROM_NODE,
  ProcessArgumentValue.JSON_PROPERTY_PROCESS_GRAPH,
  ProcessArgumentValue.JSON_PROPERTY_ID,
  ProcessArgumentValue.JSON_PROPERTY_SUMMARY,
  ProcessArgumentValue.JSON_PROPERTY_DESCRIPTION,
  ProcessArgumentValue.JSON_PROPERTY_CATEGORIES,
  ProcessArgumentValue.JSON_PROPERTY_PARAMETERS,
  ProcessArgumentValue.JSON_PROPERTY_RETURNS,
  ProcessArgumentValue.JSON_PROPERTY_DEPRECATED,
  ProcessArgumentValue.JSON_PROPERTY_EXPERIMENTAL,
  ProcessArgumentValue.JSON_PROPERTY_EXCEPTIONS,
  ProcessArgumentValue.JSON_PROPERTY_EXAMPLES,
  ProcessArgumentValue.JSON_PROPERTY_LINKS
})
...
public class ProcessArgumentValue   {
  public static final String JSON_PROPERTY_FROM_PARAMETER = "from_parameter";
  @JsonProperty(JSON_PROPERTY_FROM_PARAMETER)
  private String fromParameter;

  public static final String JSON_PROPERTY_FROM_NODE = "from_node";
   ...
   **/
  @JsonProperty(value = "from_parameter")
  ...
  public ProcessArgumentValue processGraph(Map<String, ProcessGraph> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public ProcessArgumentValue putProcessGraphItem(String key, ProcessGraph processGraphItem) {
  ...
  @ApiModelProperty(example = "ndvi", value = "The identifier for the process. It MUST be unique across its namespace (e.g. pre-defined processes or user-defined processes).  Clients SHOULD warn the user if a user-defined process is added with the  same identifier as one of the pre-defined process.")
   @Pattern(regexp="^\\w+$")
  public String getId() {
    return id;
  }
  ...
  public ProcessArgumentValue exceptions(Map<String, ProcessExceptions> exceptions) {
    this.exceptions = exceptions;
    return this;
  }

  public ProcessArgumentValue putExceptionsItem(String key, ProcessExceptions exceptionsItem) {
