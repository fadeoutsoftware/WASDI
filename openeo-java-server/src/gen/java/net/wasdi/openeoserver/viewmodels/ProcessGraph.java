 ...
 */
@JsonPropertyOrder({
  ProcessGraph.JSON_PROPERTY_PROCESS_ID,
  ProcessGraph.JSON_PROPERTY_NAMESPACE,
  ProcessGraph.JSON_PROPERTY_RESULT,
  ProcessGraph.JSON_PROPERTY_DESCRIPTION,
  ProcessGraph.JSON_PROPERTY_ARGUMENTS
})
...
public class ProcessGraph   {
  ...
  public ProcessGraph namespace(String namespace) {
    this.namespace = namespace;
    return this;
  }

  /**
   * The namespace the &#x60;process_id&#x60; is valid for.  The following options are pre-defined by the openEO API, but additional namespaces may be introduced by back-ends or in a future version of the API.  * &#x60;null&#x60; (default): Checks both user-defined and pre-defined processes,    but prefers user-defined processes if both are available.    This allows users to add missing pre-defined processes for portability,    e.g. common processes from [processes.openeo.org](https://processes.openeo.org)    that have a process graph included.    It is RECOMMENDED to log the namespace selected by the back-end for debugging purposes. * &#x60;backend&#x60;: Uses exclusively the pre-defined processes listed at &#x60;GET /processes&#x60;. * &#x60;user&#x60;: Uses exclusively the user-defined processes listed at &#x60;GET /process_graphs&#x60;.  If multiple processes with the same identifier exist, Clients SHOULD inform the user that it&#39;s recommended to select a namespace.
   * @return namespace
   **/
  @JsonProperty(value = "namespace")
  @ApiModelProperty(value = "The namespace the `process_id` is valid for.  The following options are pre-defined by the openEO API, but additional namespaces may be introduced by back-ends or in a future version of the API.  * `null` (default): Checks both user-defined and pre-defined processes,    but prefers user-defined processes if both are available.    This allows users to add missing pre-defined processes for portability,    e.g. common processes from [processes.openeo.org](https://processes.openeo.org)    that have a process graph included.    It is RECOMMENDED to log the namespace selected by the back-end for debugging purposes. * `backend`: Uses exclusively the pre-defined processes listed at `GET /processes`. * `user`: Uses exclusively the user-defined processes listed at `GET /process_graphs`.  If multiple processes with the same identifier exist, Clients SHOULD inform the user that it's recommended to select a namespace.")
  ...
  public ProcessGraph result(Boolean result) {
    this.result = result;
    return this;
  }
  ...
  public ProcessGraph description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.processId, processGraph.processId) &&
        Objects.equals(this.namespace, processGraph.namespace) &&
        Objects.equals(this.result, processGraph.result) &&
        Objects.equals(this.description, processGraph.description) &&
        Objects.equals(this.arguments, processGraph.arguments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(processId, namespace, result, description, arguments);
  }
