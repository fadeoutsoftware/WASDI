 ...
 */
@JsonPropertyOrder({
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_TITLE,
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_PROCESS,
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_ENABLED,
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_CONFIGURATION,
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_PLAN,
  UpdateSecondaryWebServiceRequest.JSON_PROPERTY_BUDGET
})
...
public class UpdateSecondaryWebServiceRequest   {
  ...
  /**
   * The billing plan to process and charge the job or service with.  Billing plans MUST be accepted in a *case insensitive* manner. If &#x60;null&#x60; is specified by the client explicitly, the server MUST store the default plan and persist it regardless of any changes to the default billing plan in the future. If given, the default plan specific to the user has higher priority than the default plan of the back-end.  The list of plans and the default plan for the back-end can be retrieved from &#x60;GET /&#x60;. The default plan for the user can be retrieved from &#x60;GET /me&#x60;. Billing plans not on the list of available plans MUST be rejected with openEO error &#x60;BillingPlanInvalid&#x60;.
   * @return plan
   **/
  @JsonProperty(value = "plan")
  @ApiModelProperty(example = "free", value = "The billing plan to process and charge the job or service with.  Billing plans MUST be accepted in a *case insensitive* manner. If `null` is specified by the client explicitly, the server MUST store the default plan and persist it regardless of any changes to the default billing plan in the future. If given, the default plan specific to the user has higher priority than the default plan of the back-end.  The list of plans and the default plan for the back-end can be retrieved from `GET /`. The default plan for the user can be retrieved from `GET /me`. Billing plans not on the list of available plans MUST be rejected with openEO error `BillingPlanInvalid`.")
  ...
  @ApiModelProperty(example = "100", value = "Maximum amount of costs the request is allowed to produce. The value MUST be specified in the currency of the back-end. No limits apply, if the value is `null`.")
  @Valid 
