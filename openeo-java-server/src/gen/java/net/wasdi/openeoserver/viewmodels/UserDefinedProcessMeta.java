...
@JsonPropertyOrder({
  UserDefinedProcessMeta.JSON_PROPERTY_SUMMARY,
  UserDefinedProcessMeta.JSON_PROPERTY_DESCRIPTION,
  UserDefinedProcessMeta.JSON_PROPERTY_PARAMETERS,
  UserDefinedProcessMeta.JSON_PROPERTY_RETURNS,
  UserDefinedProcessMeta.JSON_PROPERTY_ID,
  UserDefinedProcessMeta.JSON_PROPERTY_CATEGORIES,
  UserDefinedProcessMeta.JSON_PROPERTY_DEPRECATED,
  UserDefinedProcessMeta.JSON_PROPERTY_EXPERIMENTAL,
  UserDefinedProcessMeta.JSON_PROPERTY_EXCEPTIONS,
  UserDefinedProcessMeta.JSON_PROPERTY_EXAMPLES,
  UserDefinedProcessMeta.JSON_PROPERTY_LINKS,
  UserDefinedProcessMeta.JSON_PROPERTY_PROCESS_GRAPH
})
...
public class UserDefinedProcessMeta   {
  ...
  private Map<String, ProcessGraph> processGraph = null;

  public UserDefinedProcessMeta summary(Object summary) {
  ...
  public UserDefinedProcessMeta description(Object description) {
  ...
  public UserDefinedProcessMeta parameters(Object parameters) {
  ...
  public UserDefinedProcessMeta returns(Object returns) {
  ...
  public UserDefinedProcessMeta id(String id) {
    this.id = id;
    return this;
  }

  /**
   * The identifier for the process. It MUST be unique across its namespace (e.g. pre-defined processes or user-defined processes).  Clients SHOULD warn the user if a user-defined process is added with the  same identifier as one of the pre-defined process.
   * @return id
   **/
  @JsonProperty(value = "id")
  @ApiModelProperty(example = "ndvi", required = true, value = "The identifier for the process. It MUST be unique across its namespace (e.g. pre-defined processes or user-defined processes).  Clients SHOULD warn the user if a user-defined process is added with the  same identifier as one of the pre-defined process.")
  ...
  public UserDefinedProcessMeta categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public UserDefinedProcessMeta addCategoriesItem(String categoriesItem) {
  ...
  public UserDefinedProcessMeta deprecated(Boolean deprecated) {
  ...
  public UserDefinedProcessMeta experimental(Boolean experimental) {
  ...
  public UserDefinedProcessMeta exceptions(Map<String, ProcessExceptions> exceptions) {
    this.exceptions = exceptions;
    return this;
  }

  public UserDefinedProcessMeta putExceptionsItem(String key, ProcessExceptions exceptionsItem) {
  ...
  @ApiModelProperty(value = "Declares exceptions (errors) that might occur during execution of this process. This list is just for informative purposes and may be incomplete. This list MUST only contain exceptions that stop the execution of a process and MUST NOT contain warnings, notices or debugging messages. It is meant to primarily contain errors that have been caused by the user. It is RECOMMENDED that exceptions are referred to and explained in process or parameter descriptions.  The keys define the error code and MUST match the following pattern: `^\\w+$`  This schema follows the schema of the general openEO error list (see errors.json).")
  @Valid 
  ...
  public UserDefinedProcessMeta examples(List<ProcessExample> examples) {
    this.examples = examples;
    return this;
  }

  public UserDefinedProcessMeta addExamplesItem(ProcessExample examplesItem) {
  ...
  public UserDefinedProcessMeta links(List<Link> links) {
    this.links = links;
    return this;
  }

  public UserDefinedProcessMeta addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  public UserDefinedProcessMeta processGraph(Map<String, ProcessGraph> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public UserDefinedProcessMeta putProcessGraphItem(String key, ProcessGraph processGraphItem) {
   ...
   * @return processGraph
   **/
  @JsonProperty(value = "process_graph")
  ...
  @Valid 
  public Map<String, ProcessGraph> getProcessGraph() {
    return processGraph;
  }

  public void setProcessGraph(Map<String, ProcessGraph> processGraph) {
    this.processGraph = processGraph;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserDefinedProcessMeta userDefinedProcessMeta = (UserDefinedProcessMeta) o;
    return Objects.equals(this.summary, userDefinedProcessMeta.summary) &&
        Objects.equals(this.description, userDefinedProcessMeta.description) &&
        Objects.equals(this.parameters, userDefinedProcessMeta.parameters) &&
        Objects.equals(this.returns, userDefinedProcessMeta.returns) &&
        Objects.equals(this.id, userDefinedProcessMeta.id) &&
        Objects.equals(this.categories, userDefinedProcessMeta.categories) &&
        Objects.equals(this.deprecated, userDefinedProcessMeta.deprecated) &&
        Objects.equals(this.experimental, userDefinedProcessMeta.experimental) &&
        Objects.equals(this.exceptions, userDefinedProcessMeta.exceptions) &&
        Objects.equals(this.examples, userDefinedProcessMeta.examples) &&
        Objects.equals(this.links, userDefinedProcessMeta.links) &&
        Objects.equals(this.processGraph, userDefinedProcessMeta.processGraph);
  }

  @Override
  public int hashCode() {
    return Objects.hash(summary, description, parameters, returns, id, categories, deprecated, experimental, exceptions, examples, links, processGraph);
  }
