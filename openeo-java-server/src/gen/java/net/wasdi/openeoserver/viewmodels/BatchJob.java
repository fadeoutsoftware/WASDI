...
@JsonPropertyOrder({
  BatchJob.JSON_PROPERTY_ID,
  BatchJob.JSON_PROPERTY_TITLE,
  BatchJob.JSON_PROPERTY_DESCRIPTION,
  BatchJob.JSON_PROPERTY_PROCESS,
  BatchJob.JSON_PROPERTY_STATUS,
  BatchJob.JSON_PROPERTY_PROGRESS,
  BatchJob.JSON_PROPERTY_CREATED,
  BatchJob.JSON_PROPERTY_UPDATED,
  BatchJob.JSON_PROPERTY_PLAN,
  BatchJob.JSON_PROPERTY_COSTS,
  BatchJob.JSON_PROPERTY_BUDGET,
  BatchJob.JSON_PROPERTY_USAGE
})
...
public class BatchJob   {
  ...
  public BatchJob created(Date created) {
  ...
  public BatchJob updated(Date updated) {
  ...
  public BatchJob usage(BatchJobUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, batchJob.id) &&
        ...
        Objects.equals(this.usage, batchJob.usage);
  }
