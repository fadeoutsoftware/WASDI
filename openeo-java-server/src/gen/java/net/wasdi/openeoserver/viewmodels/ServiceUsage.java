 ...
 */
@ApiModel(description = "Metrics about the resource usage of the secondary web service.  Back-ends are not expected to update the metrics in real-time. For detailed usage metrics for individual processing steps, metrics can be added to the logs (e.g. `GET /jobs/{job_id}/logs`) with the same schema.")
@JsonPropertyOrder({
  ServiceUsage.JSON_PROPERTY_CPU,
  ServiceUsage.JSON_PROPERTY_MEMORY,
  ServiceUsage.JSON_PROPERTY_DURATION,
  ServiceUsage.JSON_PROPERTY_NETWORK,
  ServiceUsage.JSON_PROPERTY_DISK,
  ServiceUsage.JSON_PROPERTY_STORAGE
})
...
public class ServiceUsage   {
  ...
  public ServiceUsage cpu(UsageCpu cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public ServiceUsage memory(UsageMemory memory) {
    this.memory = memory;
    return this;
  }
  ...
  public ServiceUsage duration(UsageDuration duration) {
  ...
  public ServiceUsage network(UsageNetwork network) {
  ...
  public ServiceUsage disk(UsageDisk disk) {
    this.disk = disk;
    return this;
  }
  ...
  public ServiceUsage storage(UsageStorage storage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cpu, serviceUsage.cpu) &&
        Objects.equals(this.memory, serviceUsage.memory) &&
        Objects.equals(this.duration, serviceUsage.duration) &&
        Objects.equals(this.network, serviceUsage.network) &&
        Objects.equals(this.disk, serviceUsage.disk) &&
        Objects.equals(this.storage, serviceUsage.storage);
  }
