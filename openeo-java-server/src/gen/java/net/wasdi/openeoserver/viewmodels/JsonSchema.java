...
@JsonPropertyOrder({
  ...
  JsonSchema.JSON_PROPERTY_SUBTYPE,
  JsonSchema.JSON_PROPERTY_PATTERN,
  JsonSchema.JSON_PROPERTY_ENUM,
  JsonSchema.JSON_PROPERTY_MINIMUM,
  JsonSchema.JSON_PROPERTY_MAXIMUM,
  JsonSchema.JSON_PROPERTY_MIN_ITEMS,
  JsonSchema.JSON_PROPERTY_MAX_ITEMS,
  JsonSchema.JSON_PROPERTY_ITEMS,
  JsonSchema.JSON_PROPERTY_DEPRECATED
})
...
public class JsonSchema extends HashMap<String, Object>  {
  ...
  public JsonSchema type(JsonSchemaType1 type) {
    this.type = type;
    return this;
  }
  ...
  public JsonSchema items(JsonSchemaItems items) {
    this.items = items;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, subtype, pattern, _enum, minimum, maximum, minItems, maxItems, items, deprecated, super.hashCode());
  }
