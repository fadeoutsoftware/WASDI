...
public class Provider   {
  ...
  @ApiModelProperty(example = "Cool EO Cloud Corp", required = true, value = "The name of the organization or the individual.")
  @NotNull 
  ...
  @ApiModelProperty(example = "No further processing applied.", value = "Multi-line description to add further provider information such as processing details for processors and producers, hosting details for hosts or basic contact information.  CommonMark 0.29 syntax MAY be used for rich text representation.")
  ...
  public Provider addRolesItem(RolesEnum rolesItem) {
    if (this.roles == null) {
  ...
  @ApiModelProperty(example = "[\"producer\",\"licensor\",\"host\"]", value = "Roles of the provider.  The provider's role(s) can be one or more of the following elements: * licensor: The organization that is licensing the dataset under the license specified in the collection's license field. * producer: The producer of the data is the provider that initially captured and processed the source data, e.g. ESA for Sentinel-2 data. * processor: A processor is any provider who processed data to a derived product. * host: The host is the actual provider offering the data on their storage. There SHOULD be no more than one host, specified as last element of the list.")
  ...
  @ApiModelProperty(example = "http://cool-eo-cloud-corp.com", value = "Homepage on which the provider describes the dataset and publishes contact information.")
