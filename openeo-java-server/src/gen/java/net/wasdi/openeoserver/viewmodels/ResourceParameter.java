 ...
 */
@ApiModel(description = "Describes a parameter for various resources (e.g. file formats, service types).  The parameters are specified according to the [JSON Schema draft-07](http://json-schema.org/) specification. See the chapter ['Schemas' in 'Defining Processes'](#section/Processes/Defining-Processes) for more information.  The following more complex JSON Schema keywords SHOULD NOT be used: `if`, `then`, `else`, `readOnly`, `writeOnly`, `dependencies`, `minProperties`, `maxProperties`, `patternProperties`.  JSON Schemas SHOULD always be dereferenced (i.e. all `$refs` should be resolved). This allows clients to consume the schemas much better. Clients are not expected to support dereferencing `$refs`.  Note: The specified schema is only a common subset of JSON Schema. Additional keywords MAY be used.")
@JsonPropertyOrder({
  ResourceParameter.JSON_PROPERTY_DESCRIPTION,
  ResourceParameter.JSON_PROPERTY_REQUIRED,
  ResourceParameter.JSON_PROPERTY_EXPERIMENTAL,
  ResourceParameter.JSON_PROPERTY_DEFAULT,
  ResourceParameter.JSON_PROPERTY_TYPE,
  ResourceParameter.JSON_PROPERTY_SUBTYPE,
  ResourceParameter.JSON_PROPERTY_PATTERN,
  ResourceParameter.JSON_PROPERTY_ENUM,
  ResourceParameter.JSON_PROPERTY_MINIMUM,
  ResourceParameter.JSON_PROPERTY_MAXIMUM,
  ResourceParameter.JSON_PROPERTY_MIN_ITEMS,
  ResourceParameter.JSON_PROPERTY_MAX_ITEMS,
  ResourceParameter.JSON_PROPERTY_ITEMS,
  ResourceParameter.JSON_PROPERTY_DEPRECATED
})
...
public class ResourceParameter   {
  ...
  public ResourceParameter description(String description) {
    this.description = description;
    return this;
  }

  /**
   * A brief description of the parameter according to [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.10.1).
   * @return description
   **/
  @JsonProperty(value = "description")
  @ApiModelProperty(required = true, value = "A brief description of the parameter according to [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.10.1).")
  @NotNull 
  ...
  public ResourceParameter required(Boolean required) {
  ...
  public ResourceParameter experimental(Boolean experimental) {
  ...
  public ResourceParameter _default(Object _default) {
    this._default = _default;
    return this;
  }

  /**
   * The default value represents what would be assumed by the consumer of the input as the value of the parameter if none is provided. The value MUST conform to the defined type for the parameter defined at the same level. For example, if type is string, then default can be \&quot;foo\&quot; but cannot be 1. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.10.2).
   * @return _default
   **/
  @JsonProperty(value = "default")
  @ApiModelProperty(value = "The default value represents what would be assumed by the consumer of the input as the value of the parameter if none is provided. The value MUST conform to the defined type for the parameter defined at the same level. For example, if type is string, then default can be \"foo\" but cannot be 1. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.10.2).")
  ...
  public ResourceParameter type(JsonSchemaType1 type) {
    this.type = type;
    return this;
  }
  ...
  public ResourceParameter subtype(String subtype) {
    this.subtype = subtype;
    return this;
  }

  /**
   * The allowed sub data type for a value. See the chapter on [subtypes](#section/Processes/Defining-Processes) for more information.
   * @return subtype
   **/
  @JsonProperty(value = "subtype")
  @ApiModelProperty(value = "The allowed sub data type for a value. See the chapter on [subtypes](#section/Processes/Defining-Processes) for more information.")
  ...
  public ResourceParameter pattern(String pattern) {
    this.pattern = pattern;
    return this;
  }

  /**
   * The regular expression a string value must match against. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.3.3).
   * @return pattern
   **/
  @JsonProperty(value = "pattern")
  @ApiModelProperty(value = "The regular expression a string value must match against. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.3.3).")
  ...
  public ResourceParameter _enum(List<Object> _enum) {
    this._enum = _enum;
    return this;
  }

  public ResourceParameter addEnumItem(Object _enumItem) {
    if (this._enum == null) {
  ...
  /**
   * An exclusive list of allowed values. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.1.2).
   * @return _enum
   **/
  @JsonProperty(value = "enum")
  @ApiModelProperty(value = "An exclusive list of allowed values. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.1.2).")
  ...
  public ResourceParameter minimum(BigDecimal minimum) {
    this.minimum = minimum;
    return this;
  }

  /**
   * The minimum value (inclusive) allowed for a numerical value. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.2.4).
   * @return minimum
   **/
  @JsonProperty(value = "minimum")
  @ApiModelProperty(value = "The minimum value (inclusive) allowed for a numerical value. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.2.4).")
  @Valid 
  ...
  public ResourceParameter maximum(BigDecimal maximum) {
    this.maximum = maximum;
    return this;
  }

  /**
   * The maximum value (inclusive) allowed for a numerical value. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.2.2).
   * @return maximum
   **/
  @JsonProperty(value = "maximum")
  @ApiModelProperty(value = "The maximum value (inclusive) allowed for a numerical value. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.2.2).")
  @Valid 
  ...
  public ResourceParameter minItems(BigDecimal minItems) {
    this.minItems = minItems;
    return this;
  }

  /**
   * The minimum number of items required in an array. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.4.4).
   * minimum: 0
   * @return minItems
   **/
  @JsonProperty(value = "minItems")
  @ApiModelProperty(value = "The minimum number of items required in an array. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.4.4).")
  @Valid  @DecimalMin("0")
  ...
  public ResourceParameter maxItems(BigDecimal maxItems) {
    this.maxItems = maxItems;
    return this;
  }

  /**
   * The maximum number of items required in an array. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.4.3).
   * minimum: 0
   * @return maxItems
   **/
  @JsonProperty(value = "maxItems")
  @ApiModelProperty(value = "The maximum number of items required in an array. See [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.4.3).")
  @Valid  @DecimalMin("0")
  ...
  public ResourceParameter items(JsonSchemaItems items) {
    this.items = items;
    return this;
  }
  ...
  public ResourceParameter deprecated(Boolean deprecated) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, resourceParameter.description) &&
        Objects.equals(this.required, resourceParameter.required) &&
        Objects.equals(this.experimental, resourceParameter.experimental) &&
        Objects.equals(this._default, resourceParameter._default) &&
        Objects.equals(this.type, resourceParameter.type) &&
        Objects.equals(this.subtype, resourceParameter.subtype) &&
        Objects.equals(this.pattern, resourceParameter.pattern) &&
        Objects.equals(this._enum, resourceParameter._enum) &&
        Objects.equals(this.minimum, resourceParameter.minimum) &&
        Objects.equals(this.maximum, resourceParameter.maximum) &&
        Objects.equals(this.minItems, resourceParameter.minItems) &&
        Objects.equals(this.maxItems, resourceParameter.maxItems) &&
        Objects.equals(this.items, resourceParameter.items) &&
        Objects.equals(this.deprecated, resourceParameter.deprecated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, required, experimental, _default, type, subtype, pattern, _enum, minimum, maximum, minItems, maxItems, items, deprecated);
  }
