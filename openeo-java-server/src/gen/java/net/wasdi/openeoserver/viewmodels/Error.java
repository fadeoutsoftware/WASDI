...
public class Error   {
	...
	public static Error getError(String sId, String sCode, String sMessage) {
		Error oError = new Error();
		oError.setId(sId);
		oError.setCode(sCode);
		oError.setMessage(sMessage);
		
		return oError;
	}
	
	public static Error getUnathorizedError() {
		Error oError = new Error();
		oError.setId("Unauthorized");
		oError.setCode("401");
		oError.setMessage("Unauthorized");
