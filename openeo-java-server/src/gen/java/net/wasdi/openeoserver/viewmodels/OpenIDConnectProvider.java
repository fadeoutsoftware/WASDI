 ...
 */
@JsonPropertyOrder({
  OpenIDConnectProvider.JSON_PROPERTY_ID,
  OpenIDConnectProvider.JSON_PROPERTY_ISSUER,
  OpenIDConnectProvider.JSON_PROPERTY_SCOPES,
  OpenIDConnectProvider.JSON_PROPERTY_TITLE,
  OpenIDConnectProvider.JSON_PROPERTY_DESCRIPTION,
  OpenIDConnectProvider.JSON_PROPERTY_DEFAULT_CLIENTS,
  OpenIDConnectProvider.JSON_PROPERTY_LINKS
})
...
public class OpenIDConnectProvider   {
  ...
  public static final String JSON_PROPERTY_DEFAULT_CLIENTS = "default_clients";
  @JsonProperty(JSON_PROPERTY_DEFAULT_CLIENTS)
  ...
  @NotNull  @Pattern(regexp="[\\d\\w]{1,20}")
  public String getId() {
    return id;
  }
   ...
   **/
  @JsonProperty(value = "default_clients")
