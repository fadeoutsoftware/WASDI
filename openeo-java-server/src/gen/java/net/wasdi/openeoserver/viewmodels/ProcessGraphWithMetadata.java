...
@JsonPropertyOrder({
  ProcessGraphWithMetadata.JSON_PROPERTY_ID,
  ProcessGraphWithMetadata.JSON_PROPERTY_SUMMARY,
  ProcessGraphWithMetadata.JSON_PROPERTY_DESCRIPTION,
  ProcessGraphWithMetadata.JSON_PROPERTY_PARAMETERS,
  ProcessGraphWithMetadata.JSON_PROPERTY_RETURNS,
  ProcessGraphWithMetadata.JSON_PROPERTY_CATEGORIES,
  ProcessGraphWithMetadata.JSON_PROPERTY_DEPRECATED,
  ProcessGraphWithMetadata.JSON_PROPERTY_EXPERIMENTAL,
  ProcessGraphWithMetadata.JSON_PROPERTY_EXCEPTIONS,
  ProcessGraphWithMetadata.JSON_PROPERTY_EXAMPLES,
  ProcessGraphWithMetadata.JSON_PROPERTY_LINKS,
  ProcessGraphWithMetadata.JSON_PROPERTY_PROCESS_GRAPH
})
...
public class ProcessGraphWithMetadata   {
  ...
  public ProcessGraphWithMetadata exceptions(Map<String, ProcessExceptions> exceptions) {
    this.exceptions = exceptions;
    return this;
  }

  public ProcessGraphWithMetadata putExceptionsItem(String key, ProcessExceptions exceptionsItem) {
  ...
  public ProcessGraphWithMetadata processGraph(Map<String, ProcessGraph> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public ProcessGraphWithMetadata putProcessGraphItem(String key, ProcessGraph processGraphItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, summary, description, parameters, returns, categories, deprecated, experimental, exceptions, examples, links, processGraph);
  }
