 ...
 */
@JsonPropertyOrder({
  ParameterJsonSchema.JSON_PROPERTY_PARAMETERS,
  ParameterJsonSchema.JSON_PROPERTY_RETURNS,
  ParameterJsonSchema.JSON_PROPERTY_TYPE,
  ParameterJsonSchema.JSON_PROPERTY_SUBTYPE,
  ParameterJsonSchema.JSON_PROPERTY_PATTERN,
  ParameterJsonSchema.JSON_PROPERTY_ENUM,
  ParameterJsonSchema.JSON_PROPERTY_MINIMUM,
  ParameterJsonSchema.JSON_PROPERTY_MAXIMUM,
  ParameterJsonSchema.JSON_PROPERTY_MIN_ITEMS,
  ParameterJsonSchema.JSON_PROPERTY_MAX_ITEMS,
  ParameterJsonSchema.JSON_PROPERTY_ITEMS,
  ParameterJsonSchema.JSON_PROPERTY_DEPRECATED
})
...
public class ParameterJsonSchema   {
  ...
  public ParameterJsonSchema returns(JsonSchema returns) {
    this.returns = returns;
    return this;
  }

  public ParameterJsonSchema putReturnsItem(String key, JsonSchema returnsItem) {
    if (this.returns == null) {
      this.returns = returnsItem;
    }
  ...
  @ApiModelProperty(value = "Description of the data that is returned by the child process graph.")
  @Valid 
  public JsonSchema getReturns() {
    return returns;
  }

  public void setReturns(JsonSchema returns) {
    this.returns = returns;
  }

  public ParameterJsonSchema type(JsonSchemaType1 type) {
    this.type = type;
    return this;
  }
  ...
  public ParameterJsonSchema items(JsonSchemaItems items) {
    this.items = items;
    return this;
  }
  ...
  public ParameterJsonSchema deprecated(Boolean deprecated) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameters, parameterJsonSchema.parameters) &&
        Objects.equals(this.returns, parameterJsonSchema.returns) &&
        Objects.equals(this.type, parameterJsonSchema.type) &&
        ...
        Objects.equals(this.deprecated, parameterJsonSchema.deprecated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parameters, returns, type, subtype, pattern, _enum, minimum, maximum, minItems, maxItems, items, deprecated);
  }
