...
@JsonPropertyOrder({
  ...
  LogEntry.JSON_PROPERTY_CODE,
  LogEntry.JSON_PROPERTY_LEVEL,
  LogEntry.JSON_PROPERTY_MESSAGE,
  LogEntry.JSON_PROPERTY_TIME,
  LogEntry.JSON_PROPERTY_DATA,
  LogEntry.JSON_PROPERTY_PATH,
  LogEntry.JSON_PROPERTY_USAGE,
  LogEntry.JSON_PROPERTY_LINKS
})
...
public class LogEntry   {
  ...
  private List<LogEntryPathInner> path = null;
  ...
  public LogEntry time(Date time) {
    this.time = time;
    return this;
  }

  /**
   * The date and time the event happened, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.
   * @return time
   **/
  @JsonProperty(value = "time")
  @ApiModelProperty(value = "The date and time the event happened, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.")
  ...
  public LogEntry path(List<LogEntryPathInner> path) {
    this.path = path;
    return this;
  }

  public LogEntry addPathItem(LogEntryPathInner pathItem) {
    if (this.path == null) {
  ...
  /**
   * Describes where the log entry originates from.  The first element of the array is the process that has triggered the log entry, the second element is the parent of the process that has triggered the log entry, etc. This pattern is followed until the root of the process graph.
   * @return path
   **/
  @JsonProperty(value = "path")
  @ApiModelProperty(value = "Describes where the log entry originates from.  The first element of the array is the process that has triggered the log entry, the second element is the parent of the process that has triggered the log entry, etc. This pattern is followed until the root of the process graph.")
  @Valid 
  public List<LogEntryPathInner> getPath() {
    return path;
  }

  public void setPath(List<LogEntryPathInner> path) {
    this.path = path;
  }

  public LogEntry usage(Usage usage) {
    this.usage = usage;
    return this;
  }
