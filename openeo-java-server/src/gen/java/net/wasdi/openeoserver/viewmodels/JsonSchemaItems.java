...
/**
 * Specifies schemas for the items in an array according to [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.4.1).
 */
@ApiModel(description = "Specifies schemas for the items in an array according to [JSON Schema draft-07](https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.4.1).")
@JsonPropertyOrder({
  JsonSchemaItems.JSON_PROPERTY_TYPE,
  JsonSchemaItems.JSON_PROPERTY_SUBTYPE,
  JsonSchemaItems.JSON_PROPERTY_PATTERN,
  JsonSchemaItems.JSON_PROPERTY_ENUM,
  JsonSchemaItems.JSON_PROPERTY_MINIMUM,
  JsonSchemaItems.JSON_PROPERTY_MAXIMUM,
  JsonSchemaItems.JSON_PROPERTY_MIN_ITEMS,
  JsonSchemaItems.JSON_PROPERTY_MAX_ITEMS,
  JsonSchemaItems.JSON_PROPERTY_ITEMS,
  JsonSchemaItems.JSON_PROPERTY_DEPRECATED
})
...
public class JsonSchemaItems   {
  ...
  public JsonSchemaItems type(JsonSchemaType1 type) {
    this.type = type;
    return this;
  }
  ...
  public JsonSchemaItems subtype(String subtype) {
  ...
  public JsonSchemaItems pattern(String pattern) {
  ...
  public JsonSchemaItems _enum(List<Object> _enum) {
    this._enum = _enum;
    return this;
  }

  public JsonSchemaItems addEnumItem(Object _enumItem) {
    if (this._enum == null) {
  ...
  public JsonSchemaItems minimum(BigDecimal minimum) {
  ...
  public JsonSchemaItems maximum(BigDecimal maximum) {
  ...
  public JsonSchemaItems minItems(BigDecimal minItems) {
  ...
  public JsonSchemaItems maxItems(BigDecimal maxItems) {
  ...
  public JsonSchemaItems items(JsonSchemaItems items) {
    this.items = items;
    return this;
  }
  ...
  public JsonSchemaItems deprecated(Boolean deprecated) {
  ...
  public boolean equals(Object o) {
    ...
    JsonSchemaItems jsonSchemaItems = (JsonSchemaItems) o;
    return Objects.equals(this.type, jsonSchemaItems.type) &&
        Objects.equals(this.subtype, jsonSchemaItems.subtype) &&
        Objects.equals(this.pattern, jsonSchemaItems.pattern) &&
        Objects.equals(this._enum, jsonSchemaItems._enum) &&
        Objects.equals(this.minimum, jsonSchemaItems.minimum) &&
        Objects.equals(this.maximum, jsonSchemaItems.maximum) &&
        Objects.equals(this.minItems, jsonSchemaItems.minItems) &&
        Objects.equals(this.maxItems, jsonSchemaItems.maxItems) &&
        Objects.equals(this.items, jsonSchemaItems.items) &&
        Objects.equals(this.deprecated, jsonSchemaItems.deprecated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, subtype, pattern, _enum, minimum, maximum, minItems, maxItems, items, deprecated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JsonSchemaItems {\n");
