 ...
 */
@JsonPropertyOrder({
  BaseParameter.JSON_PROPERTY_NAME,
  BaseParameter.JSON_PROPERTY_DESCRIPTION,
  BaseParameter.JSON_PROPERTY_OPTIONAL,
  BaseParameter.JSON_PROPERTY_DEPRECATED,
  BaseParameter.JSON_PROPERTY_EXPERIMENTAL,
  BaseParameter.JSON_PROPERTY_DEFAULT
})
