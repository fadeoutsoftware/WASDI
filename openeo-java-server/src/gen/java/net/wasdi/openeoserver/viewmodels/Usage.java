 ...
 */
@JsonPropertyOrder({
  Usage.JSON_PROPERTY_CPU,
  Usage.JSON_PROPERTY_MEMORY,
  Usage.JSON_PROPERTY_DURATION,
  Usage.JSON_PROPERTY_NETWORK,
  Usage.JSON_PROPERTY_DISK,
...
public class Usage extends HashMap<String, ResourceUsageMetrics>  {
  ...
  public Usage memory(UsageMemory memory) {
    this.memory = memory;
    return this;
  }
  ...
  public Usage duration(UsageDuration duration) {
  ...
  public Usage network(UsageNetwork network) {
  ...
  public Usage disk(UsageDisk disk) {
    this.disk = disk;
    return this;
  }
  ...
  public Usage storage(UsageStorage storage) {
  ...
  public boolean equals(Object o) {
    ...
    Usage usage = (Usage) o;
    return Objects.equals(this.cpu, usage.cpu) &&
        Objects.equals(this.memory, usage.memory) &&
        Objects.equals(this.duration, usage.duration) &&
        Objects.equals(this.network, usage.network) &&
        Objects.equals(this.disk, usage.disk) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cpu, memory, duration, network, disk, storage, super.hashCode());
  }
