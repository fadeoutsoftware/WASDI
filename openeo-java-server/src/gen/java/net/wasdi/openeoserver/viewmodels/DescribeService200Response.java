 ...
 */
@JsonPropertyOrder({
  DescribeService200Response.JSON_PROPERTY_ID,
  DescribeService200Response.JSON_PROPERTY_TITLE,
  DescribeService200Response.JSON_PROPERTY_DESCRIPTION,
  DescribeService200Response.JSON_PROPERTY_URL,
  DescribeService200Response.JSON_PROPERTY_TYPE,
  DescribeService200Response.JSON_PROPERTY_ENABLED,
  DescribeService200Response.JSON_PROPERTY_PROCESS,
  DescribeService200Response.JSON_PROPERTY_CONFIGURATION,
  DescribeService200Response.JSON_PROPERTY_ATTRIBUTES,
  DescribeService200Response.JSON_PROPERTY_CREATED,
  DescribeService200Response.JSON_PROPERTY_PLAN,
  DescribeService200Response.JSON_PROPERTY_COSTS,
  DescribeService200Response.JSON_PROPERTY_BUDGET,
  DescribeService200Response.JSON_PROPERTY_USAGE
})
...
public class DescribeService200Response   {
  ...
  public DescribeService200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeService200Response title(String title) {
    this.title = title;
    return this;
  }
  ...
  public DescribeService200Response description(String description) {
  ...
  public DescribeService200Response url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public DescribeService200Response type(String type) {
    this.type = type;
    return this;
  }
  ...
  @ApiModelProperty(example = "wms", required = true, value = "Definition of the service type to access result data. All available service types can be retrieved via `GET /service_types`. Service types MUST be accepted in a *case insensitive* manner.")
  @NotNull 
  ...
  public DescribeService200Response enabled(Boolean enabled) {
  ...
  @ApiModelProperty(required = true, value = "Describes whether a secondary web service is responding to requests (true) or not (false). Disabled services don't produce any costs.")
  @NotNull 
  ...
  public DescribeService200Response process(ProcessGraphWithMetadata process) {
  ...
  public DescribeService200Response _configuration(Object _configuration) {
  ...
  @ApiModelProperty(example = "{\"version\":\"1.3.0\"}", required = true, value = "Map of configuration settings, i.e. the setting names supported by the secondary web service combined with actual values. See `GET /service_types` for supported configuration settings. For example, this could specify the required version of the service, visualization details or any other service dependant configuration.")
  @NotNull 
  ...
  public DescribeService200Response attributes(Object attributes) {
  ...
  @ApiModelProperty(example = "{\"layers\":[\"ndvi\",\"evi\"]}", required = true, value = "Additional attributes of the secondary web service, e.g. available layers for a WMS based on the bands in the underlying GeoTiff.")
  @NotNull 
  ...
  public DescribeService200Response created(Date created) {
  ...
  @ApiModelProperty(example = "2017-01-01T09:32:12Z", value = "Date and time of creation, formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.")
  ...
  public DescribeService200Response plan(String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public DescribeService200Response costs(BigDecimal costs) {
    this.costs = costs;
    return this;
  }
  ...
  public DescribeService200Response budget(BigDecimal budget) {
    this.budget = budget;
    return this;
  }
  ...
  public DescribeService200Response usage(ServiceUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public void setUsage(ServiceUsage usage) {
    this.usage = usage;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeService200Response describeService200Response = (DescribeService200Response) o;
    return Objects.equals(this.id, describeService200Response.id) &&
        Objects.equals(this.title, describeService200Response.title) &&
        Objects.equals(this.description, describeService200Response.description) &&
        Objects.equals(this.url, describeService200Response.url) &&
        Objects.equals(this.type, describeService200Response.type) &&
        Objects.equals(this.enabled, describeService200Response.enabled) &&
        Objects.equals(this.process, describeService200Response.process) &&
        Objects.equals(this._configuration, describeService200Response._configuration) &&
        Objects.equals(this.attributes, describeService200Response.attributes) &&
        Objects.equals(this.created, describeService200Response.created) &&
        Objects.equals(this.plan, describeService200Response.plan) &&
        Objects.equals(this.costs, describeService200Response.costs) &&
        Objects.equals(this.budget, describeService200Response.budget) &&
        Objects.equals(this.usage, describeService200Response.usage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, description, url, type, enabled, process, _configuration, attributes, created, plan, costs, budget, usage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeService200Response {\n");
