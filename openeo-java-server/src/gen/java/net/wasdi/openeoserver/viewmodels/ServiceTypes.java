 ...
 */
@JsonPropertyOrder({
  ServiceTypes.JSON_PROPERTY_TITLE,
  ServiceTypes.JSON_PROPERTY_DESCRIPTION,
  ServiceTypes.JSON_PROPERTY_DEPRECATED,
  ServiceTypes.JSON_PROPERTY_EXPERIMENTAL,
  ServiceTypes.JSON_PROPERTY_CONFIGURATION,
  ServiceTypes.JSON_PROPERTY_PROCESS_PARAMETERS,
  ServiceTypes.JSON_PROPERTY_LINKS
})
...
public class ServiceTypes   {
  ...
  private Map<String, ResourceParameter> _configuration = new HashMap<>();
  ...
  private List<Parameter> processParameters = new ArrayList<>();

  public static final String JSON_PROPERTY_LINKS = "links";
  @JsonProperty(JSON_PROPERTY_LINKS)
  private List<Link> links = null;

  public ServiceTypes title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceTypes description(String description) {
  ...
  public ServiceTypes deprecated(Boolean deprecated) {
  ...
  public ServiceTypes experimental(Boolean experimental) {
  ...
  public ServiceTypes _configuration(Map<String, ResourceParameter> _configuration) {
    this._configuration = _configuration;
    return this;
  }

  public ServiceTypes putConfigurationItem(String key, ResourceParameter _configurationItem) {
    this._configuration.put(key, _configurationItem);
    return this;
  }

  /**
   * Map of supported configuration settings made available to the creator of the service.
   * @return _configuration
   **/
  @JsonProperty(value = "configuration")
  @ApiModelProperty(required = true, value = "Map of supported configuration settings made available to the creator of the service.")
  @NotNull @Valid 
  public Map<String, ResourceParameter> getConfiguration() {
    return _configuration;
  }

  public void setConfiguration(Map<String, ResourceParameter> _configuration) {
    this._configuration = _configuration;
  }

  public ServiceTypes processParameters(List<Parameter> processParameters) {
    this.processParameters = processParameters;
    return this;
  }

  public ServiceTypes addProcessParametersItem(Parameter processParametersItem) {
   ...
   **/
  @JsonProperty(value = "process_parameters")
  @ApiModelProperty(required = true, value = "List of parameters made available to user-defined processes.")
  @NotNull @Valid 
  ...
  public ServiceTypes links(List<Link> links) {
    this.links = links;
    return this;
  }

  public ServiceTypes addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, serviceTypes.title) &&
        Objects.equals(this.description, serviceTypes.description) &&
        Objects.equals(this.deprecated, serviceTypes.deprecated) &&
        Objects.equals(this.experimental, serviceTypes.experimental) &&
        Objects.equals(this._configuration, serviceTypes._configuration) &&
        Objects.equals(this.processParameters, serviceTypes.processParameters) &&
        Objects.equals(this.links, serviceTypes.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, deprecated, experimental, _configuration, processParameters, links);
  }
