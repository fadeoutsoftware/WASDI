...
@JsonPropertyOrder({
  UserData.JSON_PROPERTY_USER_ID,
  UserData.JSON_PROPERTY_NAME,
  UserData.JSON_PROPERTY_DEFAULT_PLAN,
  UserData.JSON_PROPERTY_STORAGE,
  UserData.JSON_PROPERTY_BUDGET,
  UserData.JSON_PROPERTY_LINKS
})
...
public class UserData   {
  ...
  public UserData defaultPlan(String defaultPlan) {
    this.defaultPlan = defaultPlan;
    return this;
  }

  /**
   * Name of the plan the user has subscribed to.  Overrides the default plan of the back-end, but back-ends MAY also allow overriding this plan for each individual processing request (e.g. job or service) with the corresponding &#x60;plan&#x60; property.
   * @return defaultPlan
   **/
  @JsonProperty(value = "default_plan")
  @ApiModelProperty(example = "free", value = "Name of the plan the user has subscribed to.  Overrides the default plan of the back-end, but back-ends MAY also allow overriding this plan for each individual processing request (e.g. job or service) with the corresponding `plan` property.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, userData.userId) &&
        ...
        Objects.equals(this.defaultPlan, userData.defaultPlan) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userId, name, defaultPlan, storage, budget, links);
  }
