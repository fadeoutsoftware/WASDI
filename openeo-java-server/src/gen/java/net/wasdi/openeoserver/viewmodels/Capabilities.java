...
@JsonPropertyOrder({
  ...
  Capabilities.JSON_PROPERTY_TYPE,
...
public class Capabilities   {
  ...
  public Capabilities apiVersion(ApiVersionEnum apiVersion) {
  ...
  @ApiModelProperty(required = true, value = "Version number of the openEO specification this back-end implements.")
  @NotNull 
   ...
   **/
  @JsonProperty(value = "backend_version")
  ...
  public Capabilities type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  @ApiModelProperty(example = "Catalog", value = "For STAC versions >= 1.0.0-rc.1 this field is required.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, backendVersion, stacVersion, type, id, title, description, production, endpoints, billing, links);
  }
