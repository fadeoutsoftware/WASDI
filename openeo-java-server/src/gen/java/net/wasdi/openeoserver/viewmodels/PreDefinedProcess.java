...
/**
 * A pre-defined process made available by the back-end.
 */
@ApiModel(description = "A pre-defined process made available by the back-end.")
@JsonPropertyOrder({
  PreDefinedProcess.JSON_PROPERTY_ID,
  PreDefinedProcess.JSON_PROPERTY_SUMMARY,
  PreDefinedProcess.JSON_PROPERTY_DESCRIPTION,
  PreDefinedProcess.JSON_PROPERTY_CATEGORIES,
  PreDefinedProcess.JSON_PROPERTY_PARAMETERS,
  PreDefinedProcess.JSON_PROPERTY_RETURNS,
  PreDefinedProcess.JSON_PROPERTY_DEPRECATED,
  PreDefinedProcess.JSON_PROPERTY_EXPERIMENTAL,
  PreDefinedProcess.JSON_PROPERTY_EXCEPTIONS,
  PreDefinedProcess.JSON_PROPERTY_EXAMPLES,
  PreDefinedProcess.JSON_PROPERTY_LINKS,
  PreDefinedProcess.JSON_PROPERTY_PROCESS_GRAPH
})
...
public class PreDefinedProcess   {
  ...
  public PreDefinedProcess id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PreDefinedProcess summary(String summary) {
  ...
  public PreDefinedProcess description(String description) {
  ...
  public PreDefinedProcess categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public PreDefinedProcess addCategoriesItem(String categoriesItem) {
  ...
  public PreDefinedProcess parameters(List<ProcessParameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public PreDefinedProcess addParametersItem(ProcessParameter parametersItem) {
  ...
  @ApiModelProperty(required = true, value = "A list of parameters.  The order in the array corresponds to the parameter order to be used in clients that don't support named parameters.  **Note:** Specifying an empty array is different from (if allowed) `null` or the property being absent. An empty array means the process has no parameters. `null` / property absent means that the parameters are unknown as the user has not specified them. There could still be parameters in the process graph, if one is specified.")
  @NotNull @Valid 
  ...
  public PreDefinedProcess returns(ProcessReturnValue returns) {
  ...
  public PreDefinedProcess deprecated(Boolean deprecated) {
  ...
  public PreDefinedProcess experimental(Boolean experimental) {
  ...
  public PreDefinedProcess exceptions(Map<String, ProcessExceptions> exceptions) {
    this.exceptions = exceptions;
    return this;
  }

  public PreDefinedProcess putExceptionsItem(String key, ProcessExceptions exceptionsItem) {
  ...
  public PreDefinedProcess examples(List<ProcessExample> examples) {
    this.examples = examples;
    return this;
  }

  public PreDefinedProcess addExamplesItem(ProcessExample examplesItem) {
  ...
  public PreDefinedProcess links(List<Link> links) {
    this.links = links;
    return this;
  }

  public PreDefinedProcess addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  public PreDefinedProcess processGraph(Map<String, ProcessGraph> processGraph) {
    this.processGraph = processGraph;
    return this;
  }

  public PreDefinedProcess putProcessGraphItem(String key, ProcessGraph processGraphItem) {
  ...
  public boolean equals(Object o) {
    ...
    PreDefinedProcess preDefinedProcess = (PreDefinedProcess) o;
    return Objects.equals(this.id, preDefinedProcess.id) &&
        Objects.equals(this.summary, preDefinedProcess.summary) &&
        Objects.equals(this.description, preDefinedProcess.description) &&
        Objects.equals(this.categories, preDefinedProcess.categories) &&
        Objects.equals(this.parameters, preDefinedProcess.parameters) &&
        Objects.equals(this.returns, preDefinedProcess.returns) &&
        Objects.equals(this.deprecated, preDefinedProcess.deprecated) &&
        Objects.equals(this.experimental, preDefinedProcess.experimental) &&
        Objects.equals(this.exceptions, preDefinedProcess.exceptions) &&
        Objects.equals(this.examples, preDefinedProcess.examples) &&
        Objects.equals(this.links, preDefinedProcess.links) &&
        Objects.equals(this.processGraph, preDefinedProcess.processGraph);
  }
  ...
  public String toString() {
    ...
    sb.append("class PreDefinedProcess {\n");
