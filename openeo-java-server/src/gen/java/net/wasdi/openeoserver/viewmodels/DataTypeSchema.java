...
@JsonPropertyOrder({
  ...
  DataTypeSchema.JSON_PROPERTY_SUBTYPE,
  DataTypeSchema.JSON_PROPERTY_PATTERN,
  DataTypeSchema.JSON_PROPERTY_ENUM,
  DataTypeSchema.JSON_PROPERTY_MINIMUM,
  DataTypeSchema.JSON_PROPERTY_MAXIMUM,
  DataTypeSchema.JSON_PROPERTY_MIN_ITEMS,
  DataTypeSchema.JSON_PROPERTY_MAX_ITEMS,
  DataTypeSchema.JSON_PROPERTY_ITEMS,
  DataTypeSchema.JSON_PROPERTY_DEPRECATED
})
...
public class DataTypeSchema   {
  ...
  public DataTypeSchema type(JsonSchemaType1 type) {
    this.type = type;
    return this;
  }
  ...
  public DataTypeSchema subtype(String subtype) {
  ...
  public DataTypeSchema pattern(String pattern) {
  ...
  public DataTypeSchema _enum(List<Object> _enum) {
    this._enum = _enum;
    return this;
  }

  public DataTypeSchema addEnumItem(Object _enumItem) {
    if (this._enum == null) {
  ...
  public DataTypeSchema minimum(BigDecimal minimum) {
  ...
  public DataTypeSchema maximum(BigDecimal maximum) {
  ...
  public DataTypeSchema minItems(BigDecimal minItems) {
  ...
  public DataTypeSchema maxItems(BigDecimal maxItems) {
  ...
  public DataTypeSchema items(JsonSchemaItems items) {
    this.items = items;
    return this;
  }
  ...
  public DataTypeSchema deprecated(Boolean deprecated) {
  ...
  public boolean equals(Object o) {
    ...
    DataTypeSchema dataTypeSchema = (DataTypeSchema) o;
    return Objects.equals(this.type, dataTypeSchema.type) &&
        Objects.equals(this.subtype, dataTypeSchema.subtype) &&
        Objects.equals(this.pattern, dataTypeSchema.pattern) &&
        Objects.equals(this._enum, dataTypeSchema._enum) &&
        Objects.equals(this.minimum, dataTypeSchema.minimum) &&
        Objects.equals(this.maximum, dataTypeSchema.maximum) &&
        Objects.equals(this.minItems, dataTypeSchema.minItems) &&
        Objects.equals(this.maxItems, dataTypeSchema.maxItems) &&
        Objects.equals(this.items, dataTypeSchema.items) &&
        Objects.equals(this.deprecated, dataTypeSchema.deprecated);
  }
