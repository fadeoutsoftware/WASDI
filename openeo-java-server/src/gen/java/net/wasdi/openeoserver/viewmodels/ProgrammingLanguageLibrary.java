 ...
 */
@JsonPropertyOrder({
  ProgrammingLanguageLibrary.JSON_PROPERTY_VERSION,
  ProgrammingLanguageLibrary.JSON_PROPERTY_DEPRECATED,
  ProgrammingLanguageLibrary.JSON_PROPERTY_EXPERIMENTAL,
  ProgrammingLanguageLibrary.JSON_PROPERTY_LINKS
})
...
public class ProgrammingLanguageLibrary   {
  ...
  public ProgrammingLanguageLibrary experimental(Boolean experimental) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, programmingLanguageLibrary.version) &&
        ...
        Objects.equals(this.experimental, programmingLanguageLibrary.experimental) &&
        Objects.equals(this.links, programmingLanguageLibrary.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, deprecated, experimental, links);
  }
