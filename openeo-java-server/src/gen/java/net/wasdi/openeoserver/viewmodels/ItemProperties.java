 ...
 */
@ApiModel(description = "MAY contain additional properties other than the required property `datetime`, e.g. custom properties or properties from the STAC specification or STAC extensions.")
@JsonPropertyOrder({
  ItemProperties.JSON_PROPERTY_DATETIME,
  ItemProperties.JSON_PROPERTY_START_DATETIME,
  ItemProperties.JSON_PROPERTY_END_DATETIME,
  ItemProperties.JSON_PROPERTY_TITLE,
  ItemProperties.JSON_PROPERTY_DESCRIPTION,
  ItemProperties.JSON_PROPERTY_LICENSE,
  ItemProperties.JSON_PROPERTY_PROVIDERS,
  ItemProperties.JSON_PROPERTY_CREATED,
  ItemProperties.JSON_PROPERTY_UPDATED,
  ItemProperties.JSON_PROPERTY_EXPIRES
})
...
public class ItemProperties extends HashMap<String, Object>  {
  ...
  public ItemProperties datetime(Date datetime) {
    this.datetime = datetime;
    return this;
  }

  /**
   * The searchable date/time of the data, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.  If this field is set to &#x60;null&#x60; (usually for larger time ranges), it is STRONGLY RECOMMENDED to specify both &#x60;start_datetime&#x60; and &#x60;end_datetime&#x60; for STAC compliance.
   * @return datetime
   **/
  @JsonProperty(value = "datetime")
  @ApiModelProperty(required = true, value = "The searchable date/time of the data, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.  If this field is set to `null` (usually for larger time ranges), it is STRONGLY RECOMMENDED to specify both `start_datetime` and `end_datetime` for STAC compliance.")
  @NotNull 
  ...
  public ItemProperties startDatetime(Date startDatetime) {
    this.startDatetime = startDatetime;
    return this;
  }

  /**
   * For time series: The first or start date and time for the data, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.
   * @return startDatetime
   **/
  @JsonProperty(value = "start_datetime")
  @ApiModelProperty(value = "For time series: The first or start date and time for the data, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.")
  ...
  public ItemProperties endDatetime(Date endDatetime) {
    this.endDatetime = endDatetime;
    return this;
  }

  /**
   * For time series: The last or end date and time for the data, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.
   * @return endDatetime
   **/
  @JsonProperty(value = "end_datetime")
  @ApiModelProperty(value = "For time series: The last or end date and time for the data, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.")
  ...
  public ItemProperties title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ItemProperties description(String description) {
  ...
  @ApiModelProperty(example = "Apache-2.0", value = "License(s) of the data as a SPDX [License identifier](https://spdx.org/licenses/). Alternatively, use `proprietary` if the license is not on the SPDX license list or `various` if multiple licenses apply. In these two cases links to the license texts SHOULD be added, see the `license` link relation type.  Non-SPDX licenses SHOULD add a link to the license text with the `license` relation in the links section. The license text MUST NOT be provided as a value of this field. If there is no public license URL available, it is RECOMMENDED to host the license text and link to it.")
  ...
  public ItemProperties addProvidersItem(Provider providersItem) {
  ...
  public ItemProperties created(Date created) {
  ...
  public ItemProperties updated(Date updated) {
  ...
  public ItemProperties expires(Date expires) {
    this.expires = expires;
    return this;
  }

  /**
   * Time until which the assets are accessible, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.
   * @return expires
   **/
  @JsonProperty(value = "expires")
  @ApiModelProperty(example = "2020-11-01T00:00Z", value = "Time until which the assets are accessible, in UTC. Formatted as a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339.html) date-time.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.datetime, itemProperties.datetime) &&
        Objects.equals(this.startDatetime, itemProperties.startDatetime) &&
        Objects.equals(this.endDatetime, itemProperties.endDatetime) &&
        Objects.equals(this.title, itemProperties.title) &&
        Objects.equals(this.description, itemProperties.description) &&
        Objects.equals(this.license, itemProperties.license) &&
        Objects.equals(this.providers, itemProperties.providers) &&
        Objects.equals(this.created, itemProperties.created) &&
        Objects.equals(this.updated, itemProperties.updated) &&
        Objects.equals(this.expires, itemProperties.expires) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datetime, startDatetime, endDatetime, title, description, license, providers, created, updated, expires, super.hashCode());
  }
