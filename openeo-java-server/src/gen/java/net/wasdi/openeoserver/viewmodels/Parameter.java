 ...
 */
@JsonPropertyOrder({
  Parameter.JSON_PROPERTY_SCHEMA,
  Parameter.JSON_PROPERTY_NAME,
  Parameter.JSON_PROPERTY_DESCRIPTION,
  Parameter.JSON_PROPERTY_OPTIONAL,
  Parameter.JSON_PROPERTY_DEPRECATED,
  Parameter.JSON_PROPERTY_EXPERIMENTAL,
  Parameter.JSON_PROPERTY_DEFAULT
})
...
public class Parameter   {
  ...
  /**
   * Determines whether this parameter is optional to be specified even when no default is specified. Clients SHOULD automatically set this parameter to &#x60;true&#x60;, if a default value is specified. Back-ends SHOULD NOT fail, if a default value is specified and this flag is missing.
   * @return optional
   **/
  @JsonProperty(value = "optional")
  @ApiModelProperty(value = "Determines whether this parameter is optional to be specified even when no default is specified. Clients SHOULD automatically set this parameter to `true`, if a default value is specified. Back-ends SHOULD NOT fail, if a default value is specified and this flag is missing.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schema, name, description, optional, deprecated, experimental, _default);
  }
