...
public class BillingPlan   {
  ...
  /**
   * Name of the plan. It MUST be accepted in a *case insensitive* manner throughout the API.
   * @return name
   **/
  @JsonProperty(value = "name")
  @ApiModelProperty(example = "free", required = true, value = "Name of the plan. It MUST be accepted in a *case insensitive* manner throughout the API.")
  @NotNull 
