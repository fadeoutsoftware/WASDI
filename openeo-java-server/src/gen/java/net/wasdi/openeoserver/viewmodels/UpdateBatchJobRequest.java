 ...
 */
@JsonPropertyOrder({
  UpdateBatchJobRequest.JSON_PROPERTY_TITLE,
  UpdateBatchJobRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateBatchJobRequest.JSON_PROPERTY_PROCESS,
  UpdateBatchJobRequest.JSON_PROPERTY_PLAN,
  UpdateBatchJobRequest.JSON_PROPERTY_BUDGET
})
