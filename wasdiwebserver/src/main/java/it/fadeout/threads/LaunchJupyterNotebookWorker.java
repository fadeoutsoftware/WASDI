...
public class LaunchJupyterNotebookWorker extends Thread {
	...
	@Override
	public void run() {
		Utils.debugLog("LaunchJupyterNotebookWorker.run: start JupyterNotebook for workspaceId " + m_sWorkspaceId);
		...
		// The node was called
		Utils.debugLog("LaunchJupyterNotebookWorker.run: distribuited Jupyter Notebook started");
	}
