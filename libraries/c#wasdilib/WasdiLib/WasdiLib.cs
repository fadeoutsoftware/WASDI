...
namespace WasdiLib
{
    public class WasdiLib
    {
        ...
        public WasdiLib()
        {
            ...
            Startup.LoadConfiguration(null);
        ...
        private void LoadParametersFile()
        {
            ...
            {
                Console.WriteLine("Init: the parameters-file path is not set, trying to use the parameters.json file");
        ...
        {
            LoginResponse loginResponse = _wasdiService.Authenticate(sUser, sPassword);
        ...
        {
            LoginResponse loginResponse = _wasdiService.CheckSession(sSessionID);
        ...
        public List<Workspace> GetWorkspaces()
        {
            ...
            List<Workspace> workspaces = _workspaceService.GetWorkspaces(m_sSessionId);
        ...
        public string GetWorkspaceUrlByWsId(string workspaceId)
        {
            ...
            WorkspaceEditorViewModel workspace = _workspaceService.GetWorkspace(m_sSessionId, workspaceId);
        ...
        public List<string> GetProductsByWorkspaceId(string sWorkspaceId)
        {
            ...
            List<Product> productList = _productService.GetProductsByWorkspaceId(m_sSessionId, sWorkspaceId);
        ...
        private bool FileExistsOnWasdi(string sFileName)
        {
            ...
            return _wasdiService.FileExistsOnServer(m_sSessionId, m_sActiveWorkspace, GetWorkspaceBaseUrl(), true, sFileName);
        }
        ...
        private bool FileExistsOnNode(string sFileName)
        {
            ...
            return _wasdiService.FileExistsOnServer(m_sSessionId, m_sActiveWorkspace, GetWorkspaceBaseUrl(), false, sFileName);
        }
        ...
        public List<Workflow> GetWorkflows()
        {
            ...
            List<Workflow> workflows = _workflowService.GetWorkflows(m_sSessionId);
        ...
        {
            List<Workflow> aoWorkflows = _workflowService.GetWorkflows(m_sSessionId);
            ...
            WasdiResponse wasdiResponse = _workflowService.CreateWorkflow(m_sSessionId, workflow);
        ...
        public string GetProcessStatus(string sProcessId)
        {
            ...
            ProcessWorkspace processWorkspace = _processWorkspaceService.GetProcessWorkspaceByProcessId(m_sSessionId, sProcessId, GetWorkspaceBaseUrl());
        ...
        {
            string sResponse = _processWorkspaceService.GetProcessesStatus(m_sSessionId, asIds, GetWorkspaceBaseUrl());
        ...
        public string UpdateProcessStatus(string sProcessId, string sStatus, int iPerc)
        {
            ...
            ProcessWorkspace processWorkspace = _processWorkspaceService
                .UpdateProcessStatus(m_sSessionId, sProcessId, sStatus, iPerc, GetWorkspaceBaseUrl());
        ...
        public string UpdateProgressPerc(int iPerc)
        {
            ...
            ProcessWorkspace processWorkspace = _processWorkspaceService
                .UpdateProcessStatus(m_sSessionId, m_sMyProcId, sStatus, iPerc, GetWorkspaceBaseUrl());
        ...
        public string SetProcessPayload(string sProcessId, string sData)
        {
            ...
            ProcessWorkspace processWorkspace = _processWorkspaceService
                .UpdateProcessPayload(GetSessionId(), sProcessId, sData, GetWorkspaceBaseUrl());
        ...
        protected string InternalAddFileToWASDI(string sFileName, Boolean bAsynch, string sStyle)
        {
            ...
            WasdiResponse wasdiResponse = _wasdiService.CatalogUploadIngest(m_sSessionId, m_sActiveWorkspace, GetWorkspaceBaseUrl(), sFileName, sStyle);
        ...
        public string CreateWorkspace(string workspaceName, string nodeCode = null)
        {
            ...
            WasdiResponse wasdiResponse = _workspaceService.CreateWorkspace(m_sSessionId, workspaceName, nodeCode);
        ...
        public string DeleteWorkspace(string workspaceId)
        {
            ...
            {
                Console.WriteLine("deleteWorkspace: none passed, aborting");
                return null;
            }

            string stringValue = _workspaceService.DeleteWorkspace(m_sSessionId, workspaceId);

            if (stringValue == null)
            {
                Console.WriteLine("DeleteWorkspace: could not delete workspace (please check the return value, it's going to be null)");
            }
            else if (stringValue == "")
            {
                Console.WriteLine("DeleteWorkspace: success");
            }
            else
            {
                Console.WriteLine("DeleteWorkspace: failure: {0}", stringValue);
            }
        ...
        public List<ProcessWorkspace> GetProcessWorkspacesByWorkspaceId(string workspaceId)
        {
            ...
            List<ProcessWorkspace> processWorkspaces = _processWorkspaceService.GetProcessWorkspacesByWorkspaceId(m_sSessionId, workspaceId);
