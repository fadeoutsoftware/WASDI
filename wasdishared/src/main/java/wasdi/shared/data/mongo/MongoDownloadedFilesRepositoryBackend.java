...
/**
 * Mongo backend implementation for downloaded files repository.
 */
public class MongoDownloadedFilesRepositoryBackend extends MongoRepository implements IDownloadedFilesRepositoryBackend {

	public MongoDownloadedFilesRepositoryBackend() {
