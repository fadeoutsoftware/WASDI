...
/**
 * Mongo backend implementation for review repository.
 */
public class MongoReviewRepositoryBackend extends MongoRepository implements IReviewRepositoryBackend {

	public MongoReviewRepositoryBackend() {
	...
	public List<Review> getReviews(String sProcessorId) {
		...
		try {
			...
			FindIterable<Document> oWSDocuments = getCollection(m_sThisCollection)
					.find(new Document("processorId", sProcessorId))
