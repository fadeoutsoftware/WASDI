...
public class ResponseTranslatorOData extends ResponseTranslator {
	...
	protected  String m_sODataBaseDownloadURL = "";
	protected String m_sProvider = "";
	
	public ResponseTranslatorOData() {
		super();
	}
	...
	private QueryResultViewModel processProduct(JSONObject oJsonItem, boolean bFullViewModel) {
		...
		String sLink = m_sODataBaseDownloadURL + sProductId + SODATA_END_DOWNLOAD_URL;
