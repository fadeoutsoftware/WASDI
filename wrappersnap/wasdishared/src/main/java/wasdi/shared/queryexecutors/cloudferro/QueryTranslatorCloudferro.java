...
public class QueryTranslatorCloudferro extends QueryTranslator {
	...
	protected List<String> translateMultiple(String sQueryFromClient) {
		...
		// Cloudferro considers the timestamp, hence the moment considered is 00:00:00
		...
		for (String sCollectionName : aoCollectionNames) {
			if (!Utils.isNullOrEmpty(sCollectionName)) {
				...
				String sUrl = sBaseAddress + sCloudferroQuery;
				aoUrls.add(sUrl);
			}
		}
