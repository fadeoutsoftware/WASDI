...
/**
 * Mongo backend implementation for snap workflow repository.
 */
public class MongoSnapWorkflowRepositoryBackend extends MongoRepository implements ISnapWorkflowRepositoryBackend {

	public MongoSnapWorkflowRepositoryBackend() {
