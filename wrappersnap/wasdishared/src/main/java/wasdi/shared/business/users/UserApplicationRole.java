...
import static wasdi.shared.business.users.UserApplicationPermission.NODE_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.ORGANIZATION_READ;
import static wasdi.shared.business.users.UserApplicationPermission.ORGANIZATION_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.PROCESSOR_PARAMETERS_TEMPLATE_READ;
import static wasdi.shared.business.users.UserApplicationPermission.PROCESSOR_PARAMETERS_TEMPLATE_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.PROJECT_READ;
import static wasdi.shared.business.users.UserApplicationPermission.PROJECT_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.STYLE_READ;
import static wasdi.shared.business.users.UserApplicationPermission.STYLE_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.SUBSCRIPTION_READ;
import static wasdi.shared.business.users.UserApplicationPermission.SUBSCRIPTION_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.USER_READ;
import static wasdi.shared.business.users.UserApplicationPermission.USER_WRITE;
import static wasdi.shared.business.users.UserApplicationPermission.WORKSPACE_READ;
import static wasdi.shared.business.users.UserApplicationPermission.WORKSPACE_WRITE;
...
public enum UserApplicationRole {
	...
	ADMIN(new HashSet<UserApplicationPermission>(
			Arrays.asList(ADMIN_DASHBOARD, NODE_READ, NODE_WRITE, STYLE_READ, STYLE_WRITE, USER_READ, USER_WRITE, WORKSPACE_READ,
					ORGANIZATION_READ, ORGANIZATION_WRITE, PROJECT_READ, PROJECT_WRITE, SUBSCRIPTION_READ, SUBSCRIPTION_WRITE,
