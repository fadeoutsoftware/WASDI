...
'use strict';
angular.module('wasdi.OpportunitySearchService', ['wasdi.OpportunitySearchService']).
service('OpportunitySearchService', ['$http',  'ConstantsService', function ($http, oConstantsService) {
