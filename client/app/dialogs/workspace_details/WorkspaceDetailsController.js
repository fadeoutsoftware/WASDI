...
var WorkspaceDetailsController = (function() {
    ...
    function WorkspaceDetailsController($scope, oClose,oExtras,oWorkspaceService,oProductService,oConstantsService,oHttp, oRootScope, oProcessorService, oProcessorMediaService) {
         ...
         * @type {WorkspaceDetailsController}
         */
      ...
      * @returns {boolean}
      */
    WorkspaceDetailsController.prototype.showDragAndDrop = function() {
      ...
      * @returns {boolean|any}
      */
    WorkspaceDetailsController.prototype.tryParseJSON =function(sJsonString){
         try {
      ...
      * @returns {boolean}
      */
     WorkspaceDetailsController.prototype.updateProcessor = function (oController,oSelectedFile) {
      ...
      * @returns {boolean}
      */
    WorkspaceDetailsController.prototype.postProcessor = function (oController,oSelectedFile)
    {
        if(utilsIsObjectNullOrUndefined(oSelectedFile) === true)
        {
            return false;
      ...
      * @returns {boolean}
      */
     WorkspaceDetailsController.prototype.getListOfEnableUsers = function(sProcessorId){
      ...
      * @returns {boolean}
      */
     WorkspaceDetailsController.prototype.shareProcessorByUserEmail = function(sProcessorId, sEmail) {
      ...
      * @returns {boolean}
      */
     WorkspaceDetailsController.prototype.removeUserSharing = function(sProcessorId,sEmail){
      ...
      * @returns {boolean}
      */
     WorkspaceDetailsController.prototype.forceProcessorRefresh = function(sProcessorId) {
      ...
      * @param sCategoryId
      */
     WorkspaceDetailsController.prototype.categoryClicked = function (sCategoryId) {
      ...
      * @returns {boolean}
      */
     WorkspaceDetailsController.prototype.isCategoryChecked = function (sCategoryId) {
         if (this.m_oProcessorDetails.categories.includes(sCategoryId)) {
            return true;
         }
      ...
      */
     WorkspaceDetailsController.prototype.updateLogo = function () {
      ...
      */
     WorkspaceDetailsController.prototype.addApplicationImage = function () {
      ...
      * @param sImage
      */
     WorkspaceDetailsController.prototype.removeProcessorImage = function (sImage) {
     ...
     WorkspaceDetailsController.prototype.addUIElement = function (sElementType) {
