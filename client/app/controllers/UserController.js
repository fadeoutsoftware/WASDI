...
var UserController = (function () {
    function UserController($scope, $location, oConstantsService, oAuthService, oWorkspaceService, $state,
    ...
    UserController.prototype.getLastTouchDate = function () {
    ...
    UserController.prototype.moveTo = function (sPath) {
        this.m_oLocation.path(sPath);
    }


    UserController.prototype.createWorkspace = function () {
    ...
    UserController.prototype.openWorkspace = function (sWorkspaceId, bActiveNode) {
    ...
    UserController.prototype.getWorkspaceInfoList = function () {
        return this.m_aoWorkspaceList;
    }

    UserController.prototype.getWorkspaceViewModel = function () {
        return this.m_oWorkspaceViewModel;
    };


    UserController.prototype.fetchWorkspaceInfoList = function () {
    ...
    UserController.prototype.deselectWorskpace = function () //oWorkspace)
    {
    ...
    UserController.prototype.loadProductList = function (oWorkspace) {
        // View is leaving...
    ...
    UserController.prototype.showCursorOnWSRow = function (sWorkspaceId) {
    ...
    UserController.prototype.createBoundingBoxInGlobe = function () {
    ...
    UserController.prototype.clickOnProduct = function (oProductInput) {
    ...
    UserController.prototype.getProductList = function () {
        return this.m_aoProducts;
    };
    UserController.prototype.getProcessCount = function () {
        return this.m_Count;
    };

    UserController.prototype.isEmptyProductList = function () {
        if (utilsIsObjectNullOrUndefined(this.m_aoProducts) || this.m_aoProducts.length == 0) return true;
        return false;
    };

    UserController.prototype.isSelectedRowInWorkspaceTable = function (oWorkspace) {
     ...
     * @constructor
     */
    UserController.prototype.DeleteWorkspace = function (sWorkspaceId) {
                    ...
                    bDeleteLayer = true;
                        ...
                        oController.m_oWorkspaceService.DeleteWorkspace(oWorkspaceViewModel , bDeleteFile, bDeleteLayer)
                            .then(function () {
                                ...
                                console.log("UserController.prototype.DeleteWorkspace: oController.m_oWorkspaceService.DeleteWorkspace failed")
                            }));
        ...
        console.log("UserController.prototype.DeleteWorkspace: oController.m_oWorkspaceService.getWorkspaceEditorViewModel failed")
    }));

        
    };

    UserController.prototype.getTrackSatellite = function () {
        var oController = this;
        var iSat;
    ...
    UserController.prototype.updatePositionsSatellites = function () {
    ...
    UserController.prototype.updatePosition = function () {
        var sSatellites = "";
    ...
    UserController.prototype.getIndexActualSatellitePositions = function (sCode) {
    ...
    UserController.prototype.deleteSentinel1a = function (value) {
        if (value) {
            this.getTrackSatellite();
        } else {
    ...
    UserController.prototype.changeSorting = function(column) {
    ...
    UserController.prototype.selectedCls = function(column) {
        return column == this.sort.column && 'sort-' + this.sort.descending;
    };    


    UserController.prototype.showArrow = function(sColumn, bDescending) {
