...
require('./services/api/AuthService.js');
...
require('./services/api/FileBufferService.js');
require('./services/ProductService.js');
require('./services/ConfigurationService.js');
require('./services/api/OpenSearchService.js');
...
require('./services/api/CatalogService.js');
...
require('./app/services/api/ProjectService.js');
